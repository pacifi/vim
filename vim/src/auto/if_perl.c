...
;
#line 1081 "if_perl.xs"
	char_u *value;
#line 1288 "if_perl.c"
#line 1083 "if_perl.xs"
...
XS_EUPXS(XS_VIM_Buffers)
{
    ...
    SP -= items;
    {
#line 1100 "if_perl.xs"
    buf_T *vimbuf;
    int i, b;

#line 1321 "if_perl.c"
#line 1104 "if_perl.xs"
    if (items == 0)
    {
	if (GIMME == G_SCALAR)
	{
...
XS_EUPXS(XS_VIM_Windows)
{
    ...
    SP -= items;
    {
#line 1151 "if_perl.xs"
    win_T   *vimwin;
    int	    i, w;

#line 1384 "if_perl.c"
#line 1155 "if_perl.xs"
    if (items == 0)
    {
	if (GIMME == G_SCALAR)
