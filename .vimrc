...
"                       (_)_/ |_|_| |_| |_|_|  \___|
"
" Author: Fredy Abel Huanca Torres  <abel.huanca@upeu.pe>
" Source: 
" Basado en la configuracion de NeoBundle, Joel Castro, etc
"
...
map <Leader>rr :call VimuxRunCommand('clear;cd '.expand("%:p:h") .'; cd .. ;python2 ' .bufname("%")) <CR>
